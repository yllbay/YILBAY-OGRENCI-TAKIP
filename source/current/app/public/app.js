...
function shell(content,active=view){app().innerHTML=`<div class="top"><div class="brand-wrap"><div class="brandmark">Y</div><div><div class="brand">YILBAY Öğrenci Takip</div><div class="brand-sub">Akademik Koçluk Yönetim Sistemi</div></div></div><div class="top-right"><span class="version">v0.10.6</span></div></div><div class="layout"><aside>
...
/* CELL:10-dashboard | layer:frontend | generated-from:v0.10.6 */
...
/* CELL:30-curriculum | layer:frontend | generated-from:v0.10.6 */
...
/* CELL:40-resources | layer:frontend | generated-from:v0.10.6 */
...
/* CELL:60-assignments-results | layer:frontend | generated-from:v0.10.6 */
...
/* CELL:70-planner | layer:frontend | generated-from:v0.10.6 */
...
/* CELL:80-api-client | layer:frontend | generated-from:v0.10.6 */
...
/* CELL:90-integrations | layer:frontend | generated-from:v0.10.6 */
...
/* CELL:100-ai-planner | layer:frontend | generated-from:v0.10.6 */
...
/* CELL:110-youtube | layer:frontend | generated-from:v0.10.6 */
