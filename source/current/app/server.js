...
http.createServer(async(req,res)=>{
  try{
    ...
    if(u.pathname==="/health") return json(res,200,{ok:true,version:"0.10.9",integrations:integrationStatus()});
